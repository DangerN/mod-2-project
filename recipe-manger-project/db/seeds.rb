...
milk_steak = Recipe.create(name: 'Milk Steak', directions: 'Cook steak with milk, add jellybeans. Garnish with povery and sadness')
rice_and_tofu = Recipe.create(name: 'Tofu and Rice', directions: 'Make rice and tofu. Serve with soy sauce.')
spaghetti_and_meat_balls = Recipe.create(name: 'Spaghetti & Meatballs', directions: 'Make meat into ball. Cook meat. Make spaghetti sauce and spaghetti. Combine and serve. wa~la~')
